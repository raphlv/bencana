...
### *Real-time Hazard Tracking & Emergency Response Portal*
...
Bencana is a real-time disaster management and emergency response system designed to monitor natural hazards, shelter availability, relief distribution, and public safety alerts.

Developed to provide a robust, clean, and production-ready architecture tailored for Disaster Mitigation & Public Safety requirements.

---

## âœ¨ Key Features

- **Live Hazard Mapping & Incident Reporting Dashboard**
- **Emergency Contact & SOS Dispatch Coordination**
- **Logistics Inventory & Relief Goods Distribution Tracking**
- **Shelter Capacity & Evacuee Demographics Management**
- **Automated Early Warning Public Notifications**
...
5. **Run Local Development Server**
   `ash
   php artisan serve
   # or start via Laragon virtual host: http://bencana.test
   `
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/raphlv/bencana/issues).
